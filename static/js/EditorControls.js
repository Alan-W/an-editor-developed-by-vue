...
THREE.EditorControls = function ( object, domElement ) {
    //console.log("controls-editor",domElement);
    //object 是 相机
    //domElement 是 container 一个div
    ...
    this.getCenter = function(){
        console.log("controls的center",center);
        return center;
    }
    //ytf 复制 mousemove 事件处理函数 以备 调用
    ...
    this.pan = function ( delta ) {
        //delta的值    向右移动 x 是 负值    向下移动 y 是 正值
        //console.log("panpanpanpanpanpanpanpan函数执行");
        var distance = object.position.distanceTo( center );//对象距离中心的 距离
        //console.log("delta转化之前",delta);
        delta.multiplyScalar( distance * scope.panSpeed );
        delta.applyMatrix3( normalMatrix.getNormalMatrix( object.matrix ) );
        //console.log("delta转化之后",delta);
        //console.log("object之前位置",object.position);
        object.position.add( delta );
        //console.log("object之后位置",object.position);
        //console.log("center的之前位置",center);
        center.add( delta );
        //console.log("center的之后位置",center);
    ...
    this.zoom = function ( delta ) {
        ...
        //ytf 让它触发 controls 的 change 事件
        scope.pan( new THREE.Vector3( 0,0,0 ) );
