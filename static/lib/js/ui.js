...
UI.Element.prototype = {
	...
	setProperAttribute: function(prop, value) {
		this.dom.setAttribute(prop, value);
	},

	onChange: function(callback) { 
		this.dom.addEventListener('change', callback, false);
	},

	onFocus: function(callback) { 
		this.dom.addEventListener('focus', callback, false);
	},

	onBlur: function(callback) { 
		this.dom.addEventListener('blur', callback, false);
	},

	onInput: function(callback) {
		this.dom.addEventListener('input', callback, false);	
	} 
...
// 创建指定类型的DOM 元素
UI.DefiniteType = function (domType) {
	UI.Element.call( this );
...
UI.DefiniteType.prototype = Object.create( UI.Element.prototype );
UI.DefiniteType.prototype.constructor = UI.DefiniteType;
...
UI.ALink.prototype = Object.create( UI.Element.prototype );
UI.ALink.prototype.constructor = UI.ALink;
